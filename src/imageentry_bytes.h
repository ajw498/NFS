...
ENTRYFUNCDECL(os_error *, writebytes, (struct commonfh *fhandle, char *buffer, unsigned int len, unsigned int offset, struct file_handle *handle, struct conn_info *conn));
